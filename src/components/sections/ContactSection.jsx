...
const ContactSection = () => {
  ...
  return (
    <SectionWrapper
      ...
      className="bg-gradient-to-b from-sky-50 to-slate-100"
    >
        ...
        >
          ...
          <div className="space-y-5">
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <a
                  ...
                  className="text-sky-600 hover:text-sky-500 transition-colors duration-300"
                >
            ...
            <div className="flex items-start">
              ...
              <div>
                <h3 className="text-xl font-medium text-slate-800">Telefone</h3>
                <a
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              >
                ...
                <SelectContent>
                  <SelectItem value="Vistoria Técnica">
                    Vistoria Técnica
                  </SelectItem>
                  <SelectItem value="Laudo Técnico">Laudo Técnico</SelectItem>
                  <SelectItem value="Regularização de Imóvel">
                    Regularização de Imóvel
                  </SelectItem>
                  <SelectItem value="Consultoria/Assessoria">
            ...
            <Button
              type="submit"
              size="lg"
              className="w-full bg-sky-600 hover:bg-sky-700 text-white text-base py-3"
              disabled={isSubmitting}
            >
